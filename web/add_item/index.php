...
<?php
	...
	if(isset($_POST))
	{
			...
			$query = "INSERT INTO assets ('$item['name_id')', '$item['serial_number']', '$item['location']', '$item['model']', '$item['brand']', '$item['status']', '$item['cost']')  VALUES ('$_POST['ItemName']', '$_POST['Serial']', '$_POST['Location']', '$_POST['Model']', '$_POST['Brand']', '$_POST['Status']', '$_POST['Cost']')";
				...
				<p class="help-block"style="color:rgb(247,1,1);">' * '= required</p>
                    ...
                    <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12"  style="color:rgb(51,51,51);" name="ItemName"> Item Name <span class="required">*</span>
                        </label> 					
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="ItemName" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
						<!--Create Serial # entry-->
                      <div class="form-group">
