                        ...
                        <div class="col-md-12">
                            ...
                            <div>
							  <fieldset id="logs" style="display: none">
                                <div class="text"><label>  <input type="checkbox">Username</label></div><input type="text" id="logusername" name="logusername" value="<?php if(!(empty($_SESSION['data'][0]))){ echo $_SESSION['data'][0]; } ?>">
