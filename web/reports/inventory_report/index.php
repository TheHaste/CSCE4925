...
//Reporting Index
	...
	echo $_SESSION['inventory'][0]; echo '<br />';
	echo $_SESSION['inventory'][1]; echo '<br />';
	echo $_SESSION['inventory'][2]; echo '<br />';
	echo $_SESSION['inventory'][3]; echo '<br />';
	echo $_SESSION['inventory'][4]; echo '<br />';
	echo $_SESSION['inventory'][5]; echo '<br />';
	echo $_SESSION['inventory'][6]; echo '<br />';
	echo $_SESSION['inventory'][7]; echo '<br />';
	echo $_SESSION['inventory'][8]; echo '<br />';
